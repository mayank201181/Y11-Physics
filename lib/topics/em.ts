  ...
  quiz: {
    ...
    qa: [
      ...
      },
      {
        ...
        marks: 5,
        modelAnswer:
          "A coil is rotated in a magnetic field. As it spins, the sides of the coil cut through the magnetic field lines, inducing an e.m.f. by electromagnetic induction. As each side moves first upward and then downward through the field every half-turn, the direction of the induced e.m.f. reverses, giving an alternating output. The coil is connected to the external circuit through slip rings and brushes, which keep the output alternating. The output–time graph is a sine wave that rises to a positive peak, falls through zero, reaches a negative peak and returns — the e.m.f. is maximum when the coil moves parallel to the field and zero when it moves along the field lines. The peak voltage can be increased by spinning the coil faster (also using a stronger magnet, more turns, or a larger coil area).",
        markScheme: [
