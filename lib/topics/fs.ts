...
export const fs: Topic = {
  ...
  quiz: {
    mcq: [
      ...
      {
        id: "fs-mcq-q26",
        question: "To change the shape of an object (deform it) you need…",
        options: ["exactly one force", "more than one force", "no force at all", "only a turning force"],
        answerIndex: 1,
        explanation: "Deforming needs at least two (opposing) forces; a single unbalanced force would just make the object accelerate.",
        guideRef: "Forces that change shape",
        difficulty: "warmup",
      },
      {
        id: "fs-mcq-q27",
        question: "Pushing on the ends of a spring to make it shorter is an example of…",
        options: ["stretching", "compressing", "bending", "extension"],
        answerIndex: 1,
        explanation: "Making an object shorter by pushing is compressing (compression). Stretching makes it longer; bending curves it.",
        guideRef: "Forces that change shape",
        difficulty: "warmup",
      },
      {
        id: "fs-mcq-q28",
        question: "A spring's natural length is 8.0 cm. With a load it measures 13.0 cm. The extension is…",
        options: ["5.0 cm", "13.0 cm", "21.0 cm", "8.0 cm"],
        answerIndex: 0,
        explanation: "Extension = stretched length − natural length = 13.0 − 8.0 = 5.0 cm.",
        guideRef: "Forces that change shape",
        difficulty: "core",
        hints: ["Extension = stretched length − natural length.", "Subtract 8.0 cm from 13.0 cm.", "13.0 − 8.0 = ?"],
        strategy: "Subtract the natural length first",
      },
      {
        id: "fs-mcq-q29",
        question: "A spring is pulled with a force of 12 N, giving an extension of 0.30 m (within the limit). Using E = ½ F x, the energy stored is…",
        options: ["1.8 J", "3.6 J", "0.9 J", "4.0 J"],
        answerIndex: 0,
        explanation: "E = ½ F x = ½ × 12 × 0.30 = 1.8 J.",
        guideRef: "Energy stored in a stretched spring",
        difficulty: "core",
        hints: ["Use E = ½ F x.", "½ × 12 = 6.", "6 × 0.30 = ?"],
        strategy: "Use the ½ F x form",
      },
      {
        id: "fs-mcq-q30",
        question: "A crowbar is used to lift a heavy load. It is described as a force multiplier because…",
        options: [
          "it makes the load lighter",
          "a small effort far from the pivot balances a large load near the pivot",
          "it removes the need for any force",
          "it increases the load's weight",
        ],
        answerIndex: 1,
        explanation: "By the principle of moments, effort × effort arm = load × load arm, so a small effort at a large distance produces a large force on a close load.",
        guideRef: "Levers as force multipliers",
        difficulty: "core",
        hints: ["A lever obeys the principle of moments.", "Compare the effort's distance with the load's distance.", "Big distance × small force can equal small distance × big force."],
      },
      {
        id: "fs-mcq-q31",
        question: "A lever has its pivot 0.20 m from a 300 N load. An effort is applied 1.0 m from the pivot. The smallest effort that will balance the load is…",
        options: ["60 N", "300 N", "1500 N", "150 N"],
        answerIndex: 0,
        explanation: "effort × 1.0 = 300 × 0.20 → effort = 60 ÷ 1.0 = 60 N.",
        guideRef: "Levers as force multipliers",
        difficulty: "challenge",
        hints: ["Set effort × effort arm = load × load arm.", "effort × 1.0 = 300 × 0.20 = 60.", "effort = 60 ÷ 1.0."],
        strategy: "Apply the principle of moments to a lever",
      },
      {
        id: "fs-mcq-q32",
        question: "The centre of gravity of a uniform metre ruler is located…",
        options: ["at one end", "at the 50 cm mark (its centre)", "wherever it is held", "outside the ruler"],
        answerIndex: 1,
        explanation: "For a uniform object the centre of gravity is at the geometric centre — the 50 cm mark of a metre ruler.",
        guideRef: "Centre of gravity and stability",
        difficulty: "warmup",
      },
      {
        id: "fs-mcq-q33",
        question: "To find the centre of gravity of a flat irregular card, you can…",
        options: [
          "weigh it on a balance",
          "hang it from two points and use a plumb line, then find where the lines cross",
          "measure its longest side",
          "heat it until it bends",
        ],
        answerIndex: 1,
        explanation: "The plumb-line method: hang from two points, draw the vertical each time; the centre of gravity is where the lines cross.",
        guideRef: "Centre of gravity and stability",
        difficulty: "core",
        hints: ["You hang the shape freely from a pin.", "A plumb line shows the vertical through the centre of gravity.", "Two crossing lines locate the point."],
      },
      {
        id: "fs-mcq-q34",
        question: "A uniform beam rests on a single central pivot. For it to stay in equilibrium, which conditions must both hold?",
        options: [
          "Only the upward and downward forces must balance",
          "Only the clockwise and anticlockwise moments must balance",
          "Both the forces and the moments must balance (no resultant force and no resultant moment)",
          "The beam must have no weight",
        ],
        answerIndex: 2,
        explanation: "Equilibrium requires no resultant force (up forces = down forces) AND no resultant moment (clockwise = anticlockwise).",
        guideRef: "Principle of moments and equilibrium",
        difficulty: "challenge",
        hints: ["Equilibrium means it neither accelerates nor turns.", "That is two separate conditions.", "One about forces, one about moments."],
      },
      {
        id: "fs-mcq-q35",
        question: "Beyond the elastic limit, if you remove the force from a spring, the spring will…",
        options: [
          "return exactly to its original length",
          "stay permanently longer than its original length",
          "become stiffer with a larger k",
          "store no energy at all",
        ],
        answerIndex: 1,
        explanation: "Past the elastic limit the deformation is plastic (permanent), so the spring stays longer than its original length.",
        guideRef: "Elastic and plastic deformation",
        difficulty: "core",
        hints: ["What kind of deformation occurs past the elastic limit?", "Plastic deformation is permanent.", "Does it spring all the way back?"],
      },
    ],
    qa: [
      {
      ...
      {
        id: "fs-qa-q13",
        question: "Explain how a lever, such as a crowbar, acts as a force multiplier. Use the principle of moments in your answer. (3 marks)",
        marks: 3,
        modelAnswer:
          "A lever turns about a pivot and obeys the principle of moments: for balance, effort × distance of effort from pivot = load × distance of load from pivot. If the effort is applied much further from the pivot than the load, then a small effort produces the same (large) moment as the heavy load. This means a small effort force can balance and lift a much larger load, so the lever multiplies the force.",
        markScheme: [
          "Lever turns about a pivot / obeys principle of moments",
          "effort × effort distance = load × load distance",
          "Effort far from pivot (large distance) → small effort balances large load / multiplies force",
        ],
        commonError: "Saying the lever reduces the weight of the load — it does not change the load; it lets a smaller effort balance it by using a longer distance.",
        guideRef: "Levers as force multipliers",
        difficulty: "core",
        hints: ["What law does a lever obey?", "Write effort × distance = load × distance.", "What happens if the effort acts far from the pivot?"],
      },
      {
        id: "fs-qa-q14",
        question: "Describe how you would use the plumb-line method to find the centre of gravity of a flat, irregularly shaped piece of card. (4 marks)",
        marks: 4,
        modelAnswer:
          "Make a small hole near the edge of the card and hang it freely from a pin (or nail) so it can swing and settle. Hang a plumb line (a thread with a small weight) from the same pin and draw the vertical line it makes across the card. Make a second hole at a different point, hang the card again, and draw a second vertical line. The centre of gravity is the point where the two lines cross. A third hanging point can be used as a check.",
        markScheme: [
          "Hang the card freely from a pin so it can swing",
          "Hang a plumb line from the same point and draw the vertical",
          "Repeat from a (second) different point / draw a second line",
          "Centre of gravity is where the lines cross",
        ],
        commonError: "Drawing only one line (one line is not enough — you need at least two to locate the point), or not letting the card swing freely.",
        guideRef: "Centre of gravity and stability",
        difficulty: "core",
        hints: ["Hang the card so it can swing freely.", "Use a plumb line to mark the vertical.", "Why must you repeat from another point?"],
      },
      {
        id: "fs-qa-q15",
        question: "A uniform beam of weight 60 N and length 4.0 m rests horizontally on two supports, one at each end (A on the left, B on the right). The beam's weight acts at its centre. Calculate the upward force provided by each support. (5 marks)",
        marks: 5,
        modelAnswer:
          "The weight (60 N) acts at the centre, 2.0 m from each support, so by symmetry each support carries half. To show this with moments, take moments about A: clockwise moment of the weight = 60 × 2.0 = 120 N m; anticlockwise moment of support B = B × 4.0. For equilibrium 4.0 × B = 120, so B = 30 N. For the forces to balance (no resultant force): A + B = 60 N, so A = 60 − 30 = 30 N. Each support provides an upward force of 30 N.",
        markScheme: [
          "Take moments about one support (e.g. A)",
          "Weight's moment = 60 × 2.0 = 120 N m",
          "4.0 × B = 120 → B = 30 N",
          "Use up forces = down forces: A + B = 60 N",
          "A = 30 N (each support 30 N)",
        ],
        commonError: "Forgetting that the upward forces must also sum to the weight (using moments alone), or putting the weight at the end instead of the centre.",
        guideRef: "Principle of moments and equilibrium",
        difficulty: "challenge",
        hints: ["Take moments about one support to remove it from the equation.", "The weight acts at the centre, 2.0 m from each end.", "Then use up forces = down forces to find the other support."],
        solutions: [
          {
            label: "Method 1: moments about A, then force balance",
            steps: [
              "Take moments about A. Weight acts 2.0 m from A: clockwise moment = 60 × 2.0 = 120 N m.",
              "Support B is 4.0 m from A: anticlockwise moment = B × 4.0.",
              "Equilibrium: 4.0 × B = 120 → B = 30 N.",
              "Force balance: A + B = 60 N → A = 60 − 30 = 30 N.",
            ],
          },
          {
            label: "Method 2: symmetry",
            steps: [
              "The beam is uniform and the supports are equally spaced from the centre.",
              "The 60 N weight is shared equally between the two supports.",
              "Each support force = 60 ÷ 2 = 30 N.",
            ],
          },
        ],
      },
      {
        id: "fs-qa-q16",
        question: "A spring is stretched within its limit of proportionality. At an extension of 0.15 m the force in the spring is 6.0 N. (a) Calculate the energy stored using E = ½ F x. (b) Calculate the spring constant and confirm the same energy using E = ½ k x². (5 marks)",
        marks: 5,
        modelAnswer:
          "(a) E = ½ F x = ½ × 6.0 × 0.15 = 0.45 J. (b) k = F ÷ x = 6.0 ÷ 0.15 = 40 N/m. Then E = ½ k x² = ½ × 40 × 0.15² = ½ × 40 × 0.0225 = 0.45 J, which agrees with part (a).",
        markScheme: [
          "Use E = ½ F x = ½ × 6.0 × 0.15",
          "E = 0.45 J",
          "k = F ÷ x = 6.0 ÷ 0.15 = 40 N/m",
          "E = ½ k x² = ½ × 40 × 0.0225",
          "E = 0.45 J (consistent with part (a))",
        ],
        commonError: "Forgetting to square the extension in ½ k x², or getting different answers from the two methods (they must agree).",
        guideRef: "Energy stored in a stretched spring",
        difficulty: "challenge",
        hints: ["Part (a): E = ½ F x with F = 6.0 N, x = 0.15 m.", "Part (b): find k = F ÷ x first.", "Then E = ½ k x²; square the extension (0.15² = 0.0225)."],
        solutions: [
          {
            label: "Method: two routes to the same energy",
            steps: [
              "(a) E = ½ F x = ½ × 6.0 × 0.15 = 0.45 J.",
              "(b) k = F ÷ x = 6.0 ÷ 0.15 = 40 N/m.",
              "E = ½ k x² = ½ × 40 × 0.15² = ½ × 40 × 0.0225 = 0.45 J — matches (a).",
            ],
          },
        ],
      },
