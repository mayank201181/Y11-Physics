  ...
  guide: [
    ...
    },
    {
      ...
      keyPoints: [
        ...
        "Ion = atom that has gained electrons (negative) or lost electrons (positive); nucleus unchanged.",
      ],
    ...
    },
    {
      ...
      body:
        "**How the model of the atom changed:**\n\n1. **Plum-pudding model (Thomson, ~1904).** The atom was pictured as a ball of positive charge (the 'pudding') with tiny negative electrons dotted through it (the 'plums'). There was no nucleus and no empty space.\n2. **Alpha-scattering experiment (Geiger and Marsden, ~1909, directed by Rutherford).** Alpha particles were fired at a very thin gold foil. The plum-pudding model predicted they would all pass straight through with at most tiny deflections.\n3. **Nuclear model (Rutherford, 1911).** The surprising results forced a new model with a tiny, dense, positively charged nucleus surrounded by mostly empty space.\n\n**The results and what they show:**\n\n- Most alpha particles passed straight through → the atom is **mostly empty space**.\n- A few were deflected by large angles → there is a **small, positively charged nucleus** (like repels like).\n- Very few bounced almost straight back → the nucleus is **dense** and carries most of the **mass** and all the positive **charge**.\n\n**Background radiation** is the low-level ionising radiation that is around us all the time. Its sources include:\n\n- **Natural:** radon gas from rocks and soil (the largest source for most people), cosmic rays from space, food and drink, rocks/building materials (e.g. granite).\n- **Man-made:** medical X-rays and treatments, nuclear weapons testing fallout, nuclear power/industry (a small fraction).\n\nWhen measuring a radioactive source, we must **subtract the background count rate** to get the true (corrected) count rate from the source.",
      keyPoints: [
        "Plum-pudding model: positive 'pudding' with electrons embedded, no nucleus.",
        "Alpha scattering: most pass through (empty space); few deflect strongly (tiny dense positive nucleus).",
        "Nuclear model: the nucleus holds almost all the mass and all the positive charge.",
        "Background radiation is always present; the largest natural source is radon gas.",
        "Always subtract the background count rate from measurements (corrected count rate).",
      ],
      whyItWorks:
    ...
    },
    {
      ...
      body:
        "**Detecting radiation:**\n\n- A **Geiger–Müller (GM) tube** connected to a counter clicks/counts each ionising particle, giving a **count rate**.\n- **Photographic film** darkens when exposed to radiation — used in film badges worn by workers to monitor their total dose.\n- A **cloud chamber** or **spark chamber** reveals the **tracks** left by ionising particles as they pass through (alpha leaves short thick tracks, beta leaves longer thinner ones), letting you see individual particles.\n\n**Dangers:** ionising radiation can damage or kill living cells and can cause **mutations** in DNA that may lead to cancer. The risk depends on the **type** of radiation and whether the source is **outside** or **inside** the body:\n\n- **Outside the body**, alpha is least dangerous (stopped by skin/air), while beta and especially gamma can penetrate the skin and cause harm.\n- **Inside the body** (swallowed/inhaled), **alpha is most dangerous** because it is strongly ionising and deposits all its energy in a small region of tissue.\n\n**Irradiation vs contamination** — a key distinction:\n\n- **Irradiation** means being *exposed* to radiation from a source that is **outside** you. You are not made radioactive, and it stops the moment the source is removed or shielded.\n- **Contamination** means radioactive material (atoms) gets **onto or into** you (on skin, swallowed, inhaled). It keeps irradiating you from inside until it is removed or decays, which is why contamination by an alpha emitter is especially dangerous.\n\n**Safety / handling:**\n\n- Keep exposure **time** short (less total dose).\n- Increase your **distance** from the source (radiation spreads out and weakens).\n- Use **shielding** (lead, thick concrete) to absorb the radiation.\n- Handle sources with long **tongs**, store in **lead-lined** containers, never point at people, wear **protective equipment**/gloves to avoid contamination, and wear monitoring (film) badges.",
      keyPoints: [
        "Detectors: GM tube + counter (count rate), photographic film (dose), cloud/spark chamber (tracks).",
        ...
        "Irradiation = exposure from an outside source; contamination = radioactive material gets on/in you.",
        "Reduce risk by time, distance and shielding (plus protective equipment).",
      ],
      whyItWorks:
    ...
    },
    {
      ...
      keyPoints: [
        ...
        "Reactor parts: fuel rods (fission), moderator (slows neutrons), control rods (absorb neutrons), coolant (removes heat), shielding (absorbs radiation).",
