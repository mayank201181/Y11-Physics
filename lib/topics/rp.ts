...
export const rp: Topic = {
  ...
  quiz: {
    mcq: [
      ...
      {
        id: "rp-mcq-q27",
        question: "A neutral atom loses two electrons. The particle formed is…",
        options: ["a negative ion", "a positive ion", "a different element", "an isotope"],
        answerIndex: 1,
        explanation: "Losing electrons leaves more protons than electrons, so the particle has an overall positive charge — a positive ion. The nucleus (element) is unchanged.",
        guideRef: "Atomic number, mass number and nuclide notation",
        difficulty: "core",
        hints: ["Electrons are negative.", "Removing negatives leaves an overall… what?", "Fewer electrons than protons means a positive ion."],
      },
      {
        id: "rp-mcq-q28",
        question: "In the plum-pudding model of the atom, the atom was pictured as…",
        options: [
          "a tiny dense nucleus orbited by electrons",
          "a ball of positive charge with electrons dotted through it",
          "mostly empty space with a heavy centre",
          "neutrons surrounded by protons",
        ],
        answerIndex: 1,
        explanation: "The plum-pudding model had no nucleus: it was a sphere of positive charge ('pudding') with negative electrons ('plums') embedded in it. The nuclear model came later from alpha scattering.",
        guideRef: "Discovery of the nucleus and background radiation",
        difficulty: "core",
        hints: ["This was the model BEFORE the nucleus was discovered.", "There was no concentrated nucleus.", "Electrons were embedded in a spread-out positive charge."],
      },
      {
        id: "rp-mcq-q29",
        question: "The activity of a radioactive source is measured in becquerels (Bq). One becquerel is equal to…",
        options: ["one decay per hour", "one decay per minute", "one decay per second", "one count per metre"],
        answerIndex: 2,
        explanation: "Activity is the number of nuclear decays per second; 1 Bq = 1 decay per second.",
        guideRef: "Half-life",
        difficulty: "warmup",
      },
      {
        id: "rp-mcq-q30",
        question: "Which of the following is a man-made (artificial) source of background radiation?",
        options: ["Radon gas from rocks", "Cosmic rays from space", "Medical X-rays", "Food and drink"],
        answerIndex: 2,
        explanation: "Medical X-rays and treatments are man-made sources. Radon, cosmic rays and food/drink are all natural sources of background radiation.",
        guideRef: "Discovery of the nucleus and background radiation",
        difficulty: "core",
        hints: ["Which one involves human technology?", "Radon, cosmic rays and food are all natural.", "X-rays in hospitals are produced by machines."],
      },
      {
        id: "rp-mcq-q31",
        question: "A detector near a source reads 540 counts/min. With the source removed it reads 40 counts/min. The corrected count rate from the source is…",
        options: ["580 counts/min", "540 counts/min", "500 counts/min", "40 counts/min"],
        answerIndex: 2,
        explanation: "Corrected count rate = measured − background = 540 − 40 = 500 counts/min.",
        guideRef: "Discovery of the nucleus and background radiation",
        difficulty: "core",
        hints: ["The reading with the source removed is the background.", "Subtract background from the measured count.", "540 − 40 = 500."],
        strategy: "Always account for background",
      },
      {
        id: "rp-mcq-q32",
        question: "Which device lets you see the visible tracks left by individual ionising particles?",
        options: ["A film badge", "A cloud chamber", "A Geiger–Müller tube", "A thermometer"],
        answerIndex: 1,
        explanation: "A cloud (or spark) chamber reveals the tracks of ionising particles. A GM tube counts particles but does not show tracks; a film badge only records total dose.",
        guideRef: "Detecting radiation, dangers and safety",
        difficulty: "core",
        hints: ["Which one shows a path you can look at?", "A GM tube just clicks/counts.", "A cloud chamber shows condensation trails."],
      },
      {
        id: "rp-mcq-q33",
        question: "A worker stands near a sealed gamma source but does not touch it. They are being…",
        options: [
          "contaminated, because the source is radioactive",
          "irradiated, because they are exposed to radiation from an outside source",
          "made radioactive permanently",
          "both contaminated and irradiated",
        ],
        answerIndex: 1,
        explanation: "Exposure to radiation from a source outside the body is irradiation. Contamination only happens if radioactive material gets onto or into the body.",
        guideRef: "Detecting radiation, dangers and safety",
        difficulty: "challenge",
        hints: ["Has any radioactive material got onto or into them?", "The source is sealed and outside the body.", "Exposure from outside = irradiation."],
        strategy: "Separate irradiation from contamination",
      },
      {
        id: "rp-mcq-q34",
        question: "Gamma rays are used to sterilise medical equipment because they…",
        options: [
          "make the equipment radioactive",
          "kill bacteria/microbes without needing high temperatures",
          "are completely absorbed by the packaging",
          "cannot penetrate the equipment",
        ],
        answerIndex: 1,
        explanation: "Penetrating gamma rays pass through the sealed packaging and kill bacteria and microbes, sterilising heat-sensitive items without high temperatures. The items are not made radioactive.",
        guideRef: "Uses of radioactivity",
        difficulty: "core",
        hints: ["Why gamma and not a heat treatment?", "It must pass through the packaging.", "It kills microbes; it does not make things radioactive."],
      },
      {
        id: "rp-mcq-q35",
        question: "Carbon-14 has a half-life of about 5700 years. A wooden tool has 1/4 of the carbon-14 found in living wood. Its approximate age is…",
        options: ["about 5700 years", "about 11 400 years", "about 17 100 years", "about 2850 years"],
        answerIndex: 1,
        explanation: "1/4 = (1/2)², so 2 half-lives have passed: 2 × 5700 = 11 400 years.",
        guideRef: "Uses of radioactivity",
        difficulty: "challenge",
        hints: ["What fraction of (1/2)ⁿ equals 1/4?", "1/2 → 1/4 is two halvings.", "Age = number of half-lives × half-life."],
        strategy: "Keep halving and count the steps",
      },
      {
        id: "rp-mcq-q36",
        question: "In a nuclear reactor, what is the job of the coolant?",
        options: [
          "To absorb spare neutrons",
          "To slow down the neutrons",
          "To carry heat away from the core to make steam",
          "To shield workers from radiation",
        ],
        answerIndex: 2,
        explanation: "The coolant transfers the thermal energy from the core; this heat boils water to make steam that drives turbines. Absorbing neutrons is the control rods' job and slowing neutrons is the moderator's.",
        guideRef: "Nuclear fission and fusion",
        difficulty: "core",
        hints: ["The reaction releases a lot of heat.", "Something must carry that heat out to generate electricity.", "Coolant removes heat from the core."],
      },
      {
        id: "rp-mcq-q37",
        question: "A uranium-235 (Z = 92) nucleus absorbs a neutron and splits into barium-141 (Z = 56), krypton-92 (Z = 36) and some neutrons. How many neutrons are released?",
        options: ["1", "2", "3", "4"],
        answerIndex: 2,
        explanation: "Conserve mass number: 235 + 1 = 236 in; 141 + 92 = 233 in the daughters, leaving 236 − 233 = 3 neutrons. (Z also balances: 92 = 56 + 36.)",
        guideRef: "Nuclear fission and fusion",
        difficulty: "challenge",
        hints: ["Total mass number must be the same on both sides.", "Add the neutron to U-235: 236 nucleons in total.", "236 − (141 + 92) = number of neutrons."],
        strategy: "Conserve A to find the missing particles",
      },
      {
        id: "rp-mcq-q38",
        question: "A medical tracer should be a gamma emitter with a SHORT half-life. The short half-life is important because it…",
        options: [
          "makes the tracer easier to detect",
          "means the activity falls quickly, limiting the patient's dose",
          "stops the tracer from being absorbed",
          "lets it last for years inside the body",
        ],
        answerIndex: 1,
        explanation: "A short half-life means the source's activity drops quickly, so the patient is not irradiated for any longer than necessary, reducing the dose.",
        guideRef: "Uses of radioactivity",
        difficulty: "core",
        hints: ["What happens to activity over several half-lives?", "Do you want the patient irradiated for a long time?", "Short half-life → activity falls fast → lower dose."],
      },
    ],
    qa: [
      {
      ...
      {
        id: "rp-qa-q13",
        question: "An atom of sodium has mass number 23 and atomic number 11. (a) State the number of protons, neutrons and electrons in a neutral sodium atom. (b) The atom then loses one electron to become an ion. State the charge of the ion and explain why its atomic number does not change. (4 marks)",
        marks: 4,
        modelAnswer:
          "(a) Protons = Z = 11. Neutrons = A − Z = 23 − 11 = 12. Electrons (neutral atom) = 11. (b) Losing one electron leaves 11 protons but only 10 electrons, so there is one more positive charge than negative — the ion has a charge of +1. The atomic number does not change because it counts the number of protons in the nucleus, and forming an ion only changes the number of electrons, not the nucleus.",
        markScheme: [
          "Protons = 11",
          "Neutrons = 23 − 11 = 12",
          "Electrons = 11 (neutral atom)",
          "Ion charge +1 because it lost an electron / has 11 protons and 10 electrons; Z unchanged because only electrons change, not the nucleus/protons",
        ],
        commonError: "Thinking that gaining or losing electrons changes the atomic number — Z only counts protons in the nucleus.",
        guideRef: "Atomic number, mass number and nuclide notation",
        difficulty: "core",
        hints: ["Use Z for protons and A − Z for neutrons.", "A neutral atom has equal protons and electrons.", "Losing a negative electron leaves an overall positive charge; protons are unchanged."],
      },
      {
        id: "rp-qa-q14",
        question: "Explain the difference between irradiation and contamination, and state which is more dangerous if the source is an alpha emitter. (4 marks)",
        marks: 4,
        modelAnswer:
          "Irradiation is being exposed to radiation from a source that is outside the body; it stops as soon as the source is removed or shielded, and the person is not made radioactive. Contamination is when radioactive material (atoms) gets onto the skin or inside the body, for example by being swallowed or inhaled; it keeps irradiating the person from inside until it is removed or decays. For an alpha emitter, contamination is far more dangerous, because alpha is strongly ionising and, once inside, deposits all its energy in nearby tissue with no skin to stop it (whereas outside the body alpha is stopped by skin/air).",
        markScheme: [
          "Irradiation = exposure to radiation from an outside source / stops when source removed",
          "Contamination = radioactive material gets onto or into the body",
          "Contamination keeps irradiating from inside / until removed or decays",
          "Contamination by an alpha emitter is more dangerous because alpha is very ionising and not stopped by skin once inside",
        ],
        commonError: "Using 'irradiation' and 'contamination' as if they mean the same thing; they differ by whether the radioactive material itself is on/in the body.",
        guideRef: "Detecting radiation, dangers and safety",
        difficulty: "challenge",
        hints: ["Is the radioactive material on/in the body, or just outside it?", "Which one stops when the source is taken away?", "Why is alpha so dangerous once it is inside?"],
      },
      {
        id: "rp-qa-q15",
        question: "For EACH of the following uses, name the most suitable type of radiation (alpha, beta or gamma) and give the reason for that choice: (a) a smoke detector; (b) monitoring the thickness of aluminium foil during manufacture; (c) sterilising sealed medical instruments. (6 marks)",
        marks: 6,
        modelAnswer:
          "(a) Smoke detector: alpha. Alpha strongly ionises the air so a small current flows; it is short-range, so smoke entering the detector absorbs it and the current drops to trigger the alarm. (b) Thickness monitoring of foil: beta. Beta is partly absorbed by foil, so the amount passing through changes when the thickness changes — alpha would be completely stopped and gamma would hardly be affected, so neither would respond to small changes. (c) Sterilising sealed instruments: gamma. Gamma is very penetrating, so it passes through the sealed packaging and kills bacteria inside without needing high temperatures.",
        markScheme: [
          "Smoke detector: alpha",
          "Reason: alpha ionises air (short range) / smoke absorbs it and current drops",
          "Thickness monitoring: beta",
          "Reason: beta is partly absorbed so transmitted amount changes with thickness (alpha fully stopped / gamma barely absorbed)",
          "Sterilising: gamma",
          "Reason: gamma is very penetrating / passes through packaging to kill bacteria",
        ],
        commonError: "Choosing gamma for the thickness gauge — gamma is barely absorbed by thin foil, so it cannot detect small thickness changes.",
        guideRef: "Uses of radioactivity",
        difficulty: "core",
        hints: ["Match each job to a property: ionisation, partial absorption, penetration.", "Which radiation is partly absorbed by thin foil?", "Which radiation gets through sealed packaging?"],
      },
      {
        id: "rp-qa-q16",
        question: "Carbon-14 has a half-life of 5700 years. A piece of ancient cloth contains one eighth (1/8) of the carbon-14 found in living material. Calculate the age of the cloth and explain your method. (4 marks)",
        marks: 4,
        modelAnswer:
          "The fraction remaining is 1/8 = (1/2)³, so 3 half-lives have passed (1 → 1/2 → 1/4 → 1/8). The age = number of half-lives × half-life = 3 × 5700 = 17 100 years.",
        markScheme: [
          "Recognise 1/8 = (1/2)³ / it takes 3 halvings to reach 1/8",
          "Number of half-lives n = 3",
          "Age = n × half-life = 3 × 5700",
          "Age = 17 100 years",
        ],
        commonError: "Multiplying the half-life by 8 instead of by the number of half-lives (3).",
        guideRef: "Uses of radioactivity",
        difficulty: "challenge",
        hints: ["How many times do you halve to go from 1 to 1/8?", "1 → 1/2 → 1/4 → 1/8 is three steps.", "Age = number of half-lives × half-life."],
        solutions: [
          {
            label: "Method 1: count halvings",
            steps: [
              "Start at 1 (living material).",
              "Halve: 1 → 1/2 (1 half-life).",
              "Halve: 1/2 → 1/4 (2 half-lives).",
              "Halve: 1/4 → 1/8 (3 half-lives).",
              "Age = 3 × 5700 = 17 100 years.",
            ],
          },
          {
            label: "Method 2: use (1/2)ⁿ = 1/8",
            steps: [
              "Set (1/2)ⁿ = 1/8.",
              "1/8 = (1/2)³, so n = 3.",
              "Age = n × half-life = 3 × 5700 = 17 100 years.",
            ],
          },
        ],
      },
